    ...
    <div class="box-info-acompanhante">
        ...
        <div class="dropdown telefone">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownTelefone">
                <a class="img_whatsapp dropdown-item" href="<?php echo $url_whatsapp; ?>send?phone=55<?php echo get_dados_cadastro_pessoa('user_login'); ?>" target="_blank"><img class="img_redes_sociais" src="<?php echo get_stylesheet_directory_uri(); ?>/imagens/whatsapp.png">Falar com <?php echo get_dados_cadastro_pessoa('user_login'); ?></a>
            </div>
        </div>
        ...
        <?php $url_compartilhar = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; ?>
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownCompartilhar">
                <a class="compartilhar-pub img_whatsapp dropdown-item" href="<?php echo $url_whatsapp; ?>send?text=<?php echo $url_compartilhar; ?>" target="_blank"><img class="img_redes_sociais" src="<?php echo get_stylesheet_directory_uri(); ?>/imagens/whatsapp.png">Whatsapp</a>
                <a class="compartilhar-pub dropdown-item" href="https://twitter.com/intent/tweet?url=<?php echo $url_compartilhar; ?>" target="_blank"><img class="img_redes_sociais" src="<?php echo get_stylesheet_directory_uri(); ?>/imagens/twitter.png">Twitter</a>
            </div>
        </div>
    </div>
    ...
    <div class="box-info-acompanhante-principal">
        ...
        <div id="table-info-acompanhante-perfil">
            <table class="info-acompanhante">
                ...
                <tr>
                    <td>GPGuia:</td>
                    <td><a href="<?php echo $url_gpguia ?>" target="_blank"><?php echo $url_gpguia; ?></a></td>
                </tr>
                <?php
